    ...
    <aside id="basket-bar" :class="{active , show}">
        <div class="basket-content">
            ...
            <div class="content-wrap">
                <h3 class="basket-title"><i class="title-icon icon-cart-2"></i>Sepet <span class="basket-quantity">1</span></h3>
                                        ...
                                        <li class="list-item">
                                            <div class="productbox-mini basket has-remove">
                                                <div class="product-image-wrap">
                                                    <a href="/yag-cozucu-750ml-ve-kirec-sokucu" class="product-image imagefit fit"><img src="https://cdnd.ceptesok.com/product/420x420/c5721_Yag_Cozucu_750ml_ve_Kirec_Sokucu.jpg" class="imagefit-img abs mCS_img_loaded"></a>
                                                </div>
                                                <div class="product-description">
                                                    <h3 class="product-title"><a href="/yag-cozucu-750ml-ve-kirec-sokucu">Cillit Bang Yağ Çözücü 750ml ve Kireç Sökücü</a></h3>
                                                ...
                                                <div class="product-price">
                                                    <div class="pricebox basket">
                                                        <div class="pricebox-content"><span class="currency pricebox-currency"></span><span class="pricebox-main">34</span><span class="pricebox-decimal">90</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                ...
                <div class="basket-controls full grid-container narrow-vertical">
                    <div class="controls-prices grid-row">
                        <div class="prices-val grid-col gap-bottom-high highlight"> KDV Dahil Toplam Tutar:
                            <div class="val-price"><span class="currency"></span> 34,90 </div>
                        </div>
                    </div>
